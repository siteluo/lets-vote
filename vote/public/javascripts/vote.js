    ...
    return {
        ...
        checkLogin: function () {
            ...
            $('.subbtn').click(function (event) {
                ...
                that.reqData('/vote/index/info', 'POST', sendData, function (data) {
        ...
        indexInit: function () {
            ...
            this.manageVote();
            this.checkLogin();
            this.reqData('/vote/index/data?limit=' + limit + '&offset=0', 'GET', '', function (data) {
            ...
            $('#search').click(function (event) {
                ...
                window.location = '/vote/index/search?content=' + content
            })
        },
        /*主页上啦加载*/
        loadMore: function () {
            ...
            loadMore({
                callback: function (load) {
                    offset = offset + limit
                    if (offset < total) {
                        that.reqData('/vote/index/data?limit=' + limit + '&offset=' + offset, 'GET', '', function (data) {
                            var lists = data.data.objects;
                            /*延时是为了更好的演示效果*/
                            setTimeout(function () {
        ...
        detailInit: function () {
            ...
            console.log();
            this.reqData('/vote/all/detail/data?id=' + id, 'GET', '', function (data) {
                console.log(data);
                $('.personal').html(that.detailPersonalStr(data.data));
                $('.vflist').html(that.detailVoterStr(data.data.vfriend))
            })
        },
        searchInit: function () {
